...
export default function Prestamos() {
  ...
  useEffect(() => {
    const fetchUsuarioYPrestamos = async () => {
      setLoading(true);
      ...
      try {
        ...
        const prestamosTransformados = dataPrestamos.map((prestamo: any) => ({
          ...prestamo,
        ...
        setPrestamos(prestamosTransformados);
        setLoading(false);
      } catch (err: any) {
  ...
  const generarPrestamo = async () => {
    ...
    try {
      ...
      setPrestamos((prev) => [...prev, prestamoTransformado]);
